                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group"><label>Judul Emagazine</label>
                            <?php echo form_input($judul_emag); ?>
                        </div>
                        <div class="form-group"><label>Isi Link Emagazine</label>
                            <?php echo form_textarea($isi_link); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <p>Silahkan buat Flipbook pada website berikut <li><a href="https://www.flipbookpdf.net/">Klik Disini</a></li>
                        </p>
                    </div>
