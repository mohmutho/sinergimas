        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group"><label>Judul Emagazine</label>
                            <?php echo form_input($judul_emag, $emagazine->judul_emag);?>
                        </div>
                        <div class="form-group"><label>Isi Link Emagazine</label>
                            <?php echo form_textarea($isi_link, $emagazine->isi_link); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-4"><label>Author</label>
                                <?php echo form_input($author, $emagazine->author); ?>
                            </div>
                            <div class="col-xs-4"><label>Kategori</label>
                                <?php echo form_dropdown('', $get_combo_kategori, $emagazine->kategori, $kategori_css); ?>
                            </div>
                            <div class="col-xs-4"><label>Status Publish</label>
                                <?php echo form_dropdown('', $publish_option, $emagazine->publish, $publish_css); ?>
                            </div>
                        </div><br>
                        <div class="form-group"><label>Gambar Sebelumnya</label><br>
                            <img src="<?php echo base_url('assets/images/emag/' . $emagazine->userfile . $emagazine->userfile_type . '') ?>" width="200px" />
                        </div>
                    ...
                    <?php echo form_input($id_emag, $emagazine->id_emag); ?>
...
<script type="text/javascript">
    function tampilkanPreview(userfile, idpreview) { //membuat objek gambar
